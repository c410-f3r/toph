...
use toph_runtime::{self, opaque::Block, RuntimeApi};

#[cfg(feature = "runtime-benchmarks")]
native_executor_instance!(
  pub Executor,
  toph_runtime::api::dispatch,
  toph_runtime::native_version,
...
pub fn new_full(config: Configuration) -> Result<TaskManager, ServiceError> {
  ...
  let keystore =
    if role.is_authority() { Some(keystore as sp_core::traits::BareCryptoStorePtr) } else { None };
